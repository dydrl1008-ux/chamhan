...
export default function SettlementAdmin({ isAdmin, map, vat, runs, emplIds, maps, people, total, today, envReady }: { isAdmin: boolean; map: Record<string, string>; vat: string; runs: Run[]; emplIds: string[]; maps: { empl_id: string; user_id: string | null }[]; people: { id: string; name: string; email: string }[]; total: number; today: string; envReady: boolean }) {
